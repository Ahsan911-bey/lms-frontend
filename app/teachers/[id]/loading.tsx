    ...
    return (
        <div className="flex-1 min-w-0 h-full min-h-[50vh] flex flex-col items-center justify-center space-y-4">
            ...
            <div className="space-y-2 text-center">
                <h3 className="text-xl font-semibold text-gray-800">Loading teacher dashboard...</h3>
                <p className="text-sm text-gray-500">Please wait while we fetch your active courses</p>
            </div>
