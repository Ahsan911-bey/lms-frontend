...
import { Loader2, AlertCircle, ArrowRight, ShieldCheck, Settings, Users } from "lucide-react";
import Image from "next/image";
import { validateAdmin } from "@/lib/api";
import LoginHelp from "@/components/LoginHelp";

const loginSchema = z.object({
    id: z.number().min(1, "Admin ID is required"),
...
export default function AdminPortalLogin() {
    ...
    return (
        <div className="flex min-h-screen w-full bg-white dark:bg-zinc-950 font-sans lg:flex-row flex-col">
            ...
            <div className="relative w-full lg:w-[55%] flex flex-col items-center justify-center px-6 py-8 lg:p-16 overflow-hidden bg-purple-900">
                {/* Background Gradients/Patterns */}
                <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-900 via-zinc-900 to-indigo-900 opacity-90"></div>
                    ...
                    <div className="absolute bottom-12 right-12 w-80 h-80 bg-indigo-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
                </div>
                    ...
                    >
                        ...
                        <div className="flex flex-row items-center gap-4 mb-4 lg:flex-col lg:items-start lg:gap-0 lg:mb-6">
                            <div className="flex items-center justify-center w-12 h-12 lg:w-16 lg:h-16 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shrink-0">
                                <ShieldCheck className="w-6 h-6 lg:w-8 lg:h-8 text-purple-200" />
                            </div>
                            <h1 className="text-2xl lg:text-6xl font-bold tracking-tight text-white leading-none lg:leading-tight lg:mt-6">
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400 block lg:inline">
                                    Admin Portal
                                </span>
                            </h1>
                        </div>
                        ...
                        <p className="text-sm lg:text-lg text-zinc-300 leading-relaxed mb-6 lg:mb-8 max-w-sm lg:max-w-none">
                            Centralized control for university operations. Manage users, courses, and system settings efficiently.
                        </p>
                        ...
                        <div className="hidden lg:grid grid-cols-2 gap-4 w-full">
                            <div className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
                                ...
                                <span className="text-sm font-medium text-zinc-200">User Management</span>
                            </div>
                            <div className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
                                <Settings className="w-5 h-5 text-indigo-300" />
                                <span className="text-sm font-medium text-zinc-200">System Config</span>
                            </div>
                        </div>
                    </motion.div>
                </div>
            ...
            <div className="w-full lg:w-[45%] flex-1 flex flex-col items-center justify-center p-8 lg:p-16 bg-white dark:bg-zinc-950 relative min-h-[65vh] lg:min-h-0">
                ...
                >
                    ...
                    <div className="mb-8 text-center lg:text-left">
                        <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Sign in to Admin Console</h2>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                      ...
                      ${errors.id
                                            ...
                                            : "border-zinc-200 dark:border-zinc-800 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 bg-zinc-50 dark:bg-zinc-900"
                                        } dark:text-white`}
                                />
                                {errors.id && (
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-1">
                                    ...
                                    <a href="#" className="text-xs font-medium text-purple-600 hover:text-purple-500 dark:text-purple-400">
                                        Forgot password?
                                    </a>
                                </div>
                                <input
                      ...
                      ${errors.password
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="group relative flex w-full justify-center items-center rounded-lg bg-purple-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-purple-500/30 transition-all hover:bg-purple-500 hover:shadow-purple-500/40 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-70 dark:focus:ring-offset-zinc-950"
                        >
                            {isLoading ? (
